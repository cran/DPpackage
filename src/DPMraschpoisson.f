...
c=======================================================================                      
      subroutine dpmraschp(datastrm,imiss,nmissing,nsubject,p,y,roffset,
     &                    ngrid,grid,
     &                    maxn,a0b0,m0,s0,prec,sb,tau,
     &                    mcmc,nsave,
     &                    acrate,cpo,randsave,thetasave,densave,cdfsave,
...
c=================================================================================
      subroutine targetreslicedpm(i,nsubject,p,y,roffset,mu,sigma2,bi,
     &                            beta,out)
c=================================================================================
      implicit none
      ...
      integer j,yij
      real*8 dnrm,dpoiss,eta,mean,tmp1,tmp2
