...
c     # of arguments = 64.
c
c     Subroutine `ptglmmpois' to run a Markov chain in a semiparametric 
c     poisson mixed effect model, using a Mixture of Multivariate Polya 
...
c+++++Data
      ...
      double precision x(nrec,p+1),z(nrec,q),xtx(p,p)
...
c+++++Working space - Internal
      ...
      double precision detlogl,detloglc,dlnrm,dpoiss
