c=======================================================================                      
     ...
     &                  iflagp,betac,workmhp,workvp,xtx,xty,xsweep,     #7
...
c     # of arguments = 63.
c
c     Subroutine `dpmglmmlogit' to run a Markov chain in a semiparametric 
...
c
c     Copyright: Alejandro Jara, 2007-2008
c
c     Version 1.0:
c
c     Last modification: 21-04-2007.
c
...
c                       workvr(p).
c        xsweep      :  real matrix using for sweeping, xsweep(p+1,p+1).
...
c++++++++++ generating a candidate
            ...
            do j=1,ni
               ...
               yij=y(datastr(ii,j+1),1)            
               nij=y(datastr(ii,j+1),2)            
