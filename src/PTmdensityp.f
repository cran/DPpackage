c=======================================================================                      
      subroutine ptmdensityp(ngrid,nrec,nvar,y,
     &                       ab,nlevel,murand,sigmarand,jfr,m0,s0,nu0,
     &                       tinv,
...
c+++++++ following observations
     ...
     &              log((2.d0**nvar)*cpar+dble(i-1))
            ...
            ok=1
            j=2
            do while(ok.eq.1.and.j.le.nlevel)
               nint=2**j
               je2=j**2
               prob=1.d0/dble(nint)
...
c++++++++++ sample candidates
            ...
            logcgkn=dlnrm(cpar ,log(cparc),tune3*1.d0,1) 
            logcgko=dlnrm(cparc,log(cpar ),tune3*1.d0,1) 
