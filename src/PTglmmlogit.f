...
c+++++Data
      ...
      integer datastr(nsubject,maxni+1),y(nrec,2),typep
...
c+++++Output
      ...
      real*8 thetasave(nsave,q+nfixed+q+(q*(q+1))+1)
...
c+++++Working space - Internal
      ...
      real*8 offset
      real*8 ratio,rtlnorm,runif,tmp1
      real*8 ytilde
...
c++++++++++ generating a candidate
     ...
     &                        z(datastr(i,j+1),l)/gprime
                  ...
                  zty(k)=zty(k)+z(datastr(i,j+1),k)*ytilde/gprime
               end do
...
c     &                 workvr,workmr1,workmr2,iflagr)
            ...
            call dmvn2(q,thetac,theta,ztz,logcgko,
