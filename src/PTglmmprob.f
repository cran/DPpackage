...
c     # of arguments = 64.
c
c     Subroutine `ptglmmprob' to run a Markov chain in a semiparametric 
c     probit mixed effect model, using a Mixture of Multivariate Polya 
