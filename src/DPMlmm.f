...
c=======================================================================                      
      subroutine dpmlmm(maxni,nrec,nsubject,nfixed,p,q,subject,datastr, #8
     &                  y,x,z,xtx,                                      #4
     &                  a0b0,prec,sb,tau,nu,tinv1,smu,psiinv,tinv2,     #9
     &                  mcmc,nsave,                                     #2  
     &                  ncluster,ss,alpha,beta,b,betar,mu,sigma2e,      #8
     ...
     &                  ztz,zty,cstrt,ccluster,prob,quadf,              #6
     &                  seed,betasave,bsave)                            #3 
c=======================================================================                      
c     # of arguments = 63.
c
c     Subroutine `dpmlmm' to run a Markov chain in a semiparametric 
c     linear mixed effect model, using a Dirichlet process mixture of 
...
c                       sigmainv(q,q).
c        sigma2e     :  real giving the current value of the residual
c                       variance .
...
c         call dblepr("sigma2e",-1,sigma2e,1)
