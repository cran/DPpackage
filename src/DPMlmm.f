...
c=======================================================================                      
      subroutine dpmlmm(maxni,nrec,nsubject,nfixed,p,q,subject,datastr, 
     &                  y,x,z,xtx,                                      
     &                  a0b0,prec,sb,tau,nu,tinv1,smu,psiinv,tinv2,     
     &                  mcmc,nsave,                                       
     &                  ncluster,ss,alpha,beta,b,betar,mu,sigma2e,      
     ...
     &                  ztz,zty,cstrt,ccluster,prob,quadf,              
     &                  seed,betasave,bsave)
c=======================================================================
c     # of arguments = 63.
c
