c=======================================================================                      
      subroutine ptlm(mdzero,ngrid,nrec,p,x,y,                          #6
...
c     Version 3.0: 
c
c     Last modification: 25-08-2007.
c
...
c+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      call loglik_unifpt(nrec,mdzero,alpha,mu,sigma2,v,
...
c+++++++ evaluate log-likelihood
         ...
         call loglik_unifpt(nrec,mdzero,alpha,mu,sigma2,vc,
...
c++++++++++ evaluate log-likelihood
            ...
            call loglik_unifpt(nrec,mdzero,alpha,muc,sigma2,v,
     &                         whicho,whichn,loglikec)
...
c++++++++++ likelihood
            ...
            call loglik_unifpt(nrec,mdzero,alpha,mu,sdc**2,v,
     &                         whicho,whichn,loglikec)
...
c++++++++++ evaluate log-likelihood
            ...
            call loglik_unifpt(nrec,mdzero,alphac,mu,sigma2,v,
     &                         whicho,whichn,loglikec)
...
c+++++++++++++ errors and predictive information
               ...
               call sampufptpred(mdzero,nrec,alpha,mu,
     &                           sigma2,v,
     &                           whicho,whichn,vpred)
...
c+++++++++++++ cpo
               ...
               do i=1,nrec
                  ...
                  call condufptprior(vpred,i,mdzero,nrec,alpha,
     &                               mu,sigma2,v,
     &                               whicho,whichn,loglikec)
...
c+++++++++++++ density estimate
               ...
               do i=1,ngrid
                  ...
                  call gridufptprior(grid(i),mdzero,nrec,
     &                               alpha,mu,sigma2,v,
     &                               whicho,whichn,loglikec)
